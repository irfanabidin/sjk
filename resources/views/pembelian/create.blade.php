    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><font size="4" color="black">Tambah pembelian</font></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('nama') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nama" class="form-control" placeholder="Nama pembelian" value="{{ old('nama') }}" required="required">
                                        @if ($errors->has('nama'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('stok') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="stok" class="form-control" placeholder="Stok" value="{{ old('stok') }}" required="required">
                                        @if ($errors->has('stok'))
                                            <span class="help-block">
