    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><font size="4" color="black">Edit Data Penjualan</font></div>
                <div class="panel-body">
                    <form action="{{ route('barang.update', $barang->id) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <input type="date" name="tgl" class="form-control" placeholder="tgl" value="{{ $barang->tgl }}" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('brterjual') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="brterjual" class="form-control" placeholder="barang terjual" value="{{$barang->brterjual }}" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('hrgjual') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="hrgjual" class="form-control" placeholder="Harga Jual" value="{{$barang->hrgjual}}" required="required">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row {{ $errors->has('password-repeat') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="hrgpokok" class="form-control" placeholder="Harga Pokok" value="{{ $barang->hrgpokok }}" required="required">
                                        @if ($errors->has('password-repeat'))
                                            <span class="help-block">
